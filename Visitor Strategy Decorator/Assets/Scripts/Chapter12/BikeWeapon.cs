...
namespace Chapter.Decorator
{
    public class BikeWeapon : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect(5, 110, 150, 100), "Rate: " + _weapon.Rate);
            GUI.Label(new Rect(5, 130, 150, 100), "WeaponFiring: " + _isFiring);
            if (mainAttachment && _isDecorated)
                GUI.Label(new Rect(5, 150, 300, 100), "Main Attachment: " + mainAttachment.attachmentName);
            if (secondaryAttachment && _isDecorated)
                GUI.Label(new Rect(5, 170, 300, 100), "Secondary Attachment: " + secondaryAttachment.attachmentName);
        }
